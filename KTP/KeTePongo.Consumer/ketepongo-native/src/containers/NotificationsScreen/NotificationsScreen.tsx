...
import {
  NotificationCard, TitleSection, TypoGraphyNunitoRegular, Spinner, TypoGraphyNunitoBold, TypoGraphyNunitoLight, HeaderWithBackComponent
} from 'components';
...
import { getNotifications, markNotificationsAsRead, NotificationStatus, NotificationTypes, switchNotificationsTimer } from '../../store/notifications';
  ...
  return (
    <View style={styles.body}>
      <View style={styles.header}>
        <HeaderWithBackComponent onPress={() => navigateToMyProducts()(dispatch)} title={"Notificaciones"}/>
      </View>
