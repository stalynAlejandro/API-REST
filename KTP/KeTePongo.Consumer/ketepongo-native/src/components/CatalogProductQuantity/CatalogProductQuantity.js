...
class CatalogProductQuantity extends React.Component {
  constructor(props) {
    ...
    this.animatedQuantityBarWidth = new Animated.Value(140);
    this.animatedPedirHeight = new Animated.Value(36);
  ...
  resetQuantityDisplayButtons = () => {
    ...
    this.animatedQuantityBarWidth.setValue(100);
    this.animatedPedirHeight.setValue(36); 
  ...
  setQuantityDisplay = () => {
    ...
    this.animatedQuantityBarWidth.setValue(100);
    this.animatedPlusSign.setValue(36);
    this.animatedMinusWrapper.setValue(32);
    this.animatedMinusSign.setValue(36);
    this.animatedTrashWrapper.setValue(32);
    this.animatedTrash.setValue(36);
  }
  setQuantityBiggerThan1Display = () => {
    this.animatedMinusWrapper.setValue(32);
    this.animatedMinusSign.setValue(36);
    this.animatedTrashWrapper.setValue(0);
    this.animatedTrash.setValue(0);
  }
  setQuantityEqualTo1Display = () => {
    this.animatedMinusWrapper.setValue(0);
    this.animatedMinusSign.setValue(0);
    this.animatedTrashWrapper.setValue(32);
    this.animatedTrash.setValue(36);
  ...
  onHandlePressMinus = (orderLineQuantity) => {
    ...
    if(orderLineQuantity==2){
      this.setQuantityEqualTo1Display();
    }
  ...
  onHandlePressAdd = (orderLineQuantity) => {
    ...
    if (orderLineQuantity===1){
      this.setQuantityBiggerThan1Display();
    }
          ...
          <TouchableIcon
            ...
            icon={(
              <Animated.View style={[styles.add_button, AnimatedQuantityBar]}>
                <Animated.Image source={ASSETS.add_cart} style={AnimatedPedirText}/>
