...
import { actionConsts } from './authentication/actionTypes'
import { getAPIVersions, APIVersions } from "./authentication";
...
export const simpleAsycnActionCreator = (
  ...
  try {
    ...
    if(error.request.status === 521){
      ...
      dispatch({ type: actionConsts.SET_API_VERSIONS, payload: {apiVersions}});
