...
import { ComponentDataUser, ComponentPhoneUser, EditComponentPhone, EditComponentData, ChangePasswordTouchable, ConfirmChangeCode } from './ProfileScreen.UI'
...
import { navigateToCatalogCarte, reloadPhoneChangeRequested, reloadConfirmationCodeRequest, reloadEmailChangeRequested, reloadNameChangeRequested, reloadResendCodeChangeRequested } from '../../store/authentication/actions'
import { BasicHeaderComponent, MainTitleIndigo, BasicButtonComponent, ErrorDetail, DialogDetail } from 'components'
...
const regularExpressionPhone = /^[0-9]{11,12}$/;
...
function ProfileScreen() {
  ...
  useBackDispatch(navigateToCatalogCarte)
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        <BasicHeaderComponent onPress={() => navigateToCatalogCarte()(dispatch)} title={"Mi Cuenta"} />
        ...
        <BasicButtonComponent text={"Aceptar"} isActive={true} onPress={() => navigateToCatalogCarte()(dispatch)} />
        ...
        {(authentication.error) &&
          <ErrorDetail errorDetail={authentication.error} action={() => reloadConfirmationCodeRequest()(dispatch)} />}
      </View>
    </SafeAreaView>
  )
}
