...
export const NotAllowed = ({ onPress }) => (
  <View style={styles.not_allowed_container}>
    <View>
      <TypoGraphyOpenSans text={"Su administrador no habilitó las características de proveedor. No es posible utilizar la aplicación con esta cuenta."} style={styles.session_closed_text} />
