...
export const SessionClosed = ({ onPress }) => (
  <View style={styles.session_closed_container}>
    <View>
      <TypoGraphyOpenSans text={"Se cerró la sessión desde otro dispositivo y es necesario que vuelva a introducir sus credenciales."} style={styles.session_closed_text} />
