...
import { ComponentFactory, EmailValidator, InputHookAppFactory } from 'shared';
...
const TradeNameInput = InputHookAppFactory("tradeName", "TradeNameInput", "razon social", undefined)
...
const TelephoneInput = InputHookAppFactory("telephone", "TelephoneInput", "Escribe aquí el telefono del proveedor", undefined)
