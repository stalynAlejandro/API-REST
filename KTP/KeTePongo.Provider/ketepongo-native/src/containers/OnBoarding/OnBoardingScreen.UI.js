...
import LogoKTPhorizontal from '../../../assets/All_Icons/logoktp_onboarding_provider.svg'
...
export function OnBoardingScreen(
  ...
  return (
    ...
    <LinearGradient start={{x: -1, y: 1}} end={{x: 1, y: -0.2}} colors={[COLORS.secondary, COLORS.secondary_strong]} style={styles.container}> 
