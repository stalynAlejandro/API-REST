 ...
 return (
   <View style={isRead ? styles.cardContentRead : styles.cardContent}>
     <View style={isRead ? styles.cardIconRead : styles.cardIcon}>
      {category == NotificationCategory.AccessToCatalogConsumerRequest ? <ClientIcon/> : <ProductIcon/>}
     </View>
...
function NotificationCard(
  ...
  return (
    <TouchableItem
      onPress={category == NotificationCategory.AccessToCatalogConsumerRequest ? () => navigation.navigate(ROUTES.Clients) : undefined}
