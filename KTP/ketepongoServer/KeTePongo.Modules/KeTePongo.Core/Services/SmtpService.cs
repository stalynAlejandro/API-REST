...
namespace KeTePongo.Services
{
    public class SmtpService : ISmtpService
    {
        ...
        {
            var mailPath = Path.Combine(pickupDirectory, string.Join(";", message.To.Mailboxes).Replace("@", "AT") + " " + Guid.NewGuid().ToString() + EmailExtension);
