...
using YesSql;
using YesSql.Sql;
using DataMigration = OrchardCore.Data.Migration.Records.DataMigration;

namespace KeTePongo.Core.YesSqlCollections
{
    public class CollectionDataMigrationManager : IDataMigrationManager
    {
        ...
        public CollectionDataMigrationManager(
            ...
            YesSQLCollectionNameService yesSQLCollectionNameService)
        {
        ...
        public async Task UpdateAsync(string featureId)
        {
            ...
            foreach (var migration in migrations)
            {
                var schemaBuilder = new CollectionSchemaBuilder(new SchemaBuilder(_store.Configuration, await _session.DemandAsync()), _yesSQLCollectionNameService);
